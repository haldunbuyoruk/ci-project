...
--
-- Host: localhost:8889
-- Generation Time: Jan 09, 2017 at 05:36 PM
...
CREATE TABLE `addresses` (
  ...
  `type` enum('FATURA','KARGO') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'KARGO',
  `city_id` int(11) NOT NULL,
  `county_id` int(11) NOT NULL,
  `address` text COLLATE utf8_unicode_ci NOT NULL,
  `add_date` datetime NOT NULL,
  `update_date` datetime NOT NULL,
  `approved` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0=>''no'', 1=>''yes'''
...
CREATE TABLE `campaings` (
  ...
  `type` enum('rate','pieces','price') COLLATE utf8_unicode_ci DEFAULT 'rate',
...
CREATE TABLE `users` (
  ...
  `gender` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0 => ''man'', 1=>''women''',
